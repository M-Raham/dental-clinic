  ...
  const cases = [
    {
      ...
      beforeColor: 'from-yellow-200 to-orange-300',
    ...
    },
    {
      ...
      afterColor: 'from-white to-pink-50',
    },
    {
      id: 3,
      ...
      beforeColor: 'from-yellow-100 to-yellow-200',
      afterColor: 'from-white to-blue-50',
    },
    {
      id: 4,
      ...
      beforeColor: 'from-gray-200 to-gray-400',
      afterColor: 'from-white to-blue-50',
    },
  ];
            ...
            >
              ...
              <div className="relative h-64 overflow-hidden">
                <div className="absolute inset-0 grid grid-cols-2">
                  {/* Before */}
                  <div className={`bg-gradient-to-br ${caseItem.beforeColor} relative`}>
                  ...
                  {/* After */}
                  <div className={`bg-gradient-to-br ${caseItem.afterColor} relative`}>
                    <div className="absolute inset-0 flex items-center justify-center">
                      <div className="text-center">
                        <div className="w-16 h-16 bg-white/50 rounded-full mx-auto mb-2 flex items-center justify-center backdrop-blur-sm">
